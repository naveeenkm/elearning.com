...
<header>
    <h1>Names of faculty and the courses they are teaching</h1><br>
...
<input type="hidden" name="id[]" value="<?php echo $id1; ?>">
    ...
    <h5>Enter the faculty id it starts from 1:</h5>
...
<?php
            if (isset($_GET['courseid'])) {
                ...
                $sql="SELECT faculty.faculty_id,faculty.faculty_name, courses.course_name,courses.course_id
                FROM faculty, lectures, courses
                WHERE faculty.faculty_id = lectures.faculty_id AND lectures.course_id = courses.course_id and faculty.faculty_id = $facultyid;";
