...
<?php
            if (isset($_GET['courseid'])) {
                ...
                $sql="select * from studentlogs where student_id=$facultyid;
                ";
        ...
        $facultyid = $_GET['courseid'];
                ...
                $fname1=$row["last_name"];
                $fage=$row["student_age"];
                $fexp=$row["student_gender"];
                $fexp1=$row["action"];
                $fexp2=$row["date and time"];
               echo ' <tr>
            ...
            echo $facultyid. ' student id has no history...<br>';
