...
if(isset($_POST['submit'])){
  ...
  $sql="insert into completes(student_id,assign_id)
  values('$studentid','$assignid')";
  ...
  <div class="container">
    ...
    <form method="post">
      ...
      <div class="form-group">
        ...
        <input type="number" class="form-control" placeholder="Enter Assignment id" name="assignid">
      </div><br>
    ...
    <button class="btn btn-primary "><a href="entity.php?id[]=<?php echo $id1; ?>&id[]=<?php echo $id2; ?>" class="text-light">Entites</a></button>
      <button  class="btn btn-primary" ><a href="dcompletes.php?id[]=<?php echo $id1; ?>&id[]=<?php echo $id2; ?>" class="text-light">Display </a></button>
  </div>
</section>
